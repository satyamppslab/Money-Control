...
import { LogOut, Wallet, PlusCircle, ScanLine, LayoutDashboard, User as UserIcon } from 'lucide-react';

const Navbar = () => {
  const { user, logout, currency, setCurrency, CURRENCY_SYMBOLS } = useAuth();
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <select
                ...
                className="bg-slate-900 border border-slate-800 text-slate-300 text-xs rounded-md px-2 py-1.5 focus:outline-none focus:border-brand-500 transition-colors cursor-pointer"
              >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2 pl-4 border-l border-slate-800">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 px-3 py-1.5 rounded-md text-xs font-semibold border border-rose-500/20 transition-all cursor-pointer"
                  >
